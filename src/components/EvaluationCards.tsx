...
const EvaluationCards: React.FC<CardProps> = ({
  ...
  return (
    <section className="lg:max-w-[37rem] bg-[var(--talentmal-color-seven)] lg:pt-10 lg:pl-7 p-4 md:rounded-tl-[32px] rounded-tl-[14px]">
      ...
      <h2 className="text-[20px] font-medium md:text-[28px] leading-[130%] md:-tracking-[1px] -tracking-[0.46px] my-2">{title}</h2>
      <p className="text-[12px] md:text-[16px] lg:text-[18px] text-[var(--talentmal-color-one)] leading:[12px] md:leading-[140%] md:-tracking-[0.46px] mb-3 pr-5">
        {detail}
      </p>
