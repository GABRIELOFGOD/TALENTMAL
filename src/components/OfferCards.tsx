  ...
  return (
    <main className="">
      <div className="lg:max-w-[31.1rem] border border-[#D7D7D7] bg-[var(--talentmal-color-six)] rounded-[22px] p-5">
        ...
        <h1 className="text-[20px] md:text-[32px] font-medium md:font-black my-3">{title}</h1>
        <p className="text-[14px] md:text-[20px] leading-[130%] tracking-wide text-[var(--talentmal-color-one)]">
          {detail}
        </p>
      </div>
    </main>
