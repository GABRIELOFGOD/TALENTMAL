    ...
    <main className="lg:flex gap-5">
      <section className="lg:w-1/2 px-4">
        <div>
          ...
          <p className="hidden lg:block text-[14px] lg:text-[24px] lg:leading-[130%] leading-[18.2px] lg:-tracking-[1px] text-[var(--talentmal-color-three)]">
          ...
          <p className="lg:hidden text-[14px] lg:text-[24px] lg:leading-[130%] leading-[18.2px] lg:-tracking-[1px] text-[var(--talentmal-color-three)]">
            TalentMAL matches vetted Junior level/Mid-level/Senior level experts
            in Africa to global tech companies and startups. Our aim is to
            enable companies to have access to a broader pool of candidates
            regardless of location or governmental restrictions.
        ...
        <div className="my-[3rem]">
          ...
          <p className="text-[14px] lg:text-[24px] lg:leading-[130%] leading-[18.2px] lg:-tracking-[1px] text-[var(--talentmal-color-three)]">
