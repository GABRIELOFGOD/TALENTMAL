...
const FAQ: React.FC = () => {
  ...
  return (
    <main>
      <section>
        <h1 className="text-[56px] leading-[120%] -tracking-[2px]">FAQs</h1>
        ...
        <button className="border text-[17px] text-[var(--talentmal-color-nine)] px-4 py-2 rounded-full">SEND US A QUESTION</button>
      </section>
