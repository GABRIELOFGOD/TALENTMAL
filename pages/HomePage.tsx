    ...
    <main className="container mx-auto">
      <section className="md:flex md:items-center w-full mt-10 px-4">
        <div className="md:w-3/5">
          ...
          <p className="mt-3 lg:mt-7 md:w-[49rem] md:text-[22px] text-[14px] text-[var(--talentmal-color-one)] leading-[140%] lg:-tracking-[1px]">
          ...
          <div className="mt-3 lg:mt-6 flex flex-col lg:flex-row lg:items-center lg:gap-2">
            ...
            <p className="text-[12px] lg:text-[14px] lg:-tracking-[0.5px] leading-[100%] md:leading-none mt-3 lg:mt-0">
